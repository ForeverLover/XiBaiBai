 ...
 * 打蜡服务适配器
 */
public class BeautyWaxAdapter extends BaseAdapter {
    ...
    public BeautyWaxAdapter(List<BeautyItemProduct> waxList,int carType){
        this.waxList = waxList;
        this.carType = carType;
        checkState = new boolean[waxList.size()];
        initCheckState();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BeautyItemProduct itemProduct = waxList.get(position);
